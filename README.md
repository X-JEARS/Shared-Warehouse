...
- **二维码扫描**: 扫描物品二维码进入批量取走模式，扫描盒子二维码进入批量放入模式；物品可在人与人、人与仓库之间自由流动；支持手电筒照明，高清视频流提升小二维码识别率
...
- **通知**: 通知列表显示未读消息，支持单条标记已读和全部标记已读；底栏图标显示红色徽章标示未读通知数量
...
- **简洁界面**: 仓库页面右上角添加物品，设置按钮使用齿轮图标（有待处理的加入申请时显示红色徽章），购物车仅在有物品时显示，创建/加入仓库入口在仓库下拉菜单中
